...
export type FiltrosLaboratoriosValues = {
  id: number | null;
  nombre: string;
  estatus: string;
};
...
type FilterProps = {
  sendFilters: (filters: FiltrosLaboratoriosValues) => void;
};

export default function FiltrosLaboratorios({ sendFilters }: FilterProps) {
