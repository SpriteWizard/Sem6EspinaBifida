...
export function NewMovementModal({
  ...
  function handleEsComodatoCheckedChange(next: boolean) {
    ...
    setShowDisableComodatoConfirm(true)
  }

  function confirmDisableComodato() {
    setNotes('')
    setComodatoAQuien('')
    setComodatoTiempo('')
    setComodatoCondiciones('')
  ...
  function cancelDisableComodato() {
    setShowDisableComodatoConfirm(false)
  }
  ...
  return (
    ...
    >
      ...
      <Modal
        open={showDisableComodatoConfirm}
        titleId="disable-comodato-confirm-title"
        title="Desactivar comodato"
        onClose={cancelDisableComodato}
        className="max-w-md"
      >
        <div className="px-5 py-4">
          <p className="text-sm leading-6 text-slate-600">
            Si desactivas el comodato, se borrarán la descripción y las respuestas del comodato.
            ¿Continuar?
          </p>

          <div className="mt-6 flex flex-wrap justify-end gap-3 border-t border-slate-100 pt-4">
            <Button type="button" variant="secondary" onClick={cancelDisableComodato}>
              Cancelar
            </Button>
